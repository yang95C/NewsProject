package com.yg.newsproject.baselibs.widget;
...
//            "W", "X", "Y", "Z", "#"};
    ...
    public IndexWord initpaint(List<String> s) {//初始化文本画笔
        words = s;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                //获取被点击的字幕，然后回调出去
                if (indexPressWord != null && index >= 0 && index < words.size()) {
                    indexPressWord.setIndexPressWord(words.get(index));
                }
